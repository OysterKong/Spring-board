...
<script>
	let msg = "${msg}";
	if(msg=="Modify well completed") alert("성공적으로 수정되었습니다.");
	if(msg=="Write well completed") alert("성공적으로 등록되었습니다.");
	if(msg=="Delete well completed") alert("성공적으로 삭제되었습니다.");
	
	if(msg=="Delete error") alert("삭제되었거나 없는 게시물입니다.");
	if(msg=="Read error") alert("삭제되었거나 없는 게시물입니다.");
	if(msg=="List error") alert("게시물 목록을 가져오는데 실패했습니다.");
</script>
